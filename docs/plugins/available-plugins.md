...
- [**plugin-testing-integration**](https://github.com/seznam/IMA.js-plugins/tree/master/packages/plugin-testing-integration) - Deprecated, use the [`@ima/testing-library/integration`](../basic-features/testing.md#integration-testing) entry point instead.
