...
<div id="imajs">
  <div class="is-flex is-flex-column is-limited-width">
    ...
    <p class="has-text-centered">
      <a href="https://github.com/seznam/IMA.js-skeleton/archive/master.zip" class="button is-medium is-primary">
          <span class="icon">
            <i class="fas fa-download"></i>
          </span>
          <span>Get Started</span>
      </a>
      <a href="https://github.com/seznam/IMA.js-skeleton/archive/master.zip" class="button is-medium is-text">
          <span class="icon">
            <i class="fas fa-download"></i>
          </span>
