...
interface DictionaryInterface {
  [key: string]: {
    [key: string]: (params: { [key: string]: number | string }) => string;
  };
}
 ...
 * @extends Dictionary
 */
export default class MessageFormatDictionary implements Dictionary {
  protected _language: string;
  // protected _dictionary: { [key: string]: { [key: string]: function({ [key: string]: number | string}): string}}
   ...
   */
  _getScope(key: string): null | (() => string | DictionaryInterface) {
