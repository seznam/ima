...
export default class ClientPageRenderer extends AbstractPageRenderer {
  ...
  _updateMetaNameAttributes(metaManager) {
    ...
    for (let metaTagKey of metaManager.getMetaNames()) {
      ...
      newMetaTag.setAttribute('data-ima-meta', true);
  ...
  _updateMetaPropertyAttributes(metaManager) {
    ...
    for (let metaTagKey of metaManager.getMetaProperties()) {
      const newMetaTag = this._window.getDocument().createElement('meta');
  ...
  _updateMetaLinkAttributes(metaManager) {
    ...
    for (let linkTagRel of metaManager.getLinks()) {
      ...
      newLinkTag.setAttribute('data-ima-meta', true);
