export var init = (ns) => {
	...
	ns.oc.bind('CATEGORIES_API_URL', baseUrl + ns.Setting.Api.categories);
	ns.oc.bind('ITEMS_API_URL', baseUrl + ns.Setting.Api.items);
	...
	ns.oc.bind('CategoryListResource', ns.oc.make('App.Module.CategoryList.Resource', ['FakeHttp', 'CATEGORIES_API_URL', 'CategoryListFactory', '$Cache']));
	...
	ns.oc.bind('ItemResource', ns.oc.make('App.Module.Item.Resource', ['FakeHttp', 'ITEMS_API_URL', 'ItemFactory', '$Cache']));
	...
	ns.oc.bind('FeedResource', ns.oc.make('App.Module.Feed.Resource', ['FakeHttp', 'ITEMS_API_URL', 'FeedFactory', '$Cache']));
