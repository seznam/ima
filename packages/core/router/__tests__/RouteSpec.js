	...
	describe('should create right path -', function() {
		using(
			[
				...
				{
					pathExpression:
						'/:someId-:?someName/:?cntr/:?price/:?sort/:?page',
					params: {
						someId: 11,
						cntr: 'gb',
						price: 'all',
				...
				{
					pathExpression:
						'/:someId-:?someName/:?locality/:?price/:?sort/:?page',
				...
				{
					pathExpression:
						':param/home/:userId/something/:?somethingId/',
				...
				{
					pathExpression:
						'/:?optional/home/:userId/something/:someId/',
					params: { optional: 'too-bad', userId: 1, someId: 2 },
					result: '/too-bad/home/1/something/2'
				},
				{
					pathExpression:
						'/home/:userId/:?optional/something/:someId',
			...
			function(value) {
				...
				it(
					...
					function() {
						expect(localRoute.toPath(value.params)).toEqual(
							value.result
						);
					}
				);
		...
		it('for empty variables will be return defined path', function() {
			expect(route.toPath()).toEqual(
				'/home/:userId/something/:somethingId'
			);
		});
		...
		using(
			[
				...
				{
					pathExpression:
						'/home/:userId/something/:somethingId/:?optional2/',
					params: {
						userId: 'hello',
						somethingId: 'job',
						optional2: 'today'
		...
		using(
			[
				...
				},
				{
					pathExpression: multipleParamsExpr,
					path:
						'/offer/flowers/524175-red-roses/120415247/winter2017',
					params: {
						group: 'flowers',
						catId: '524175',
						catName: 'red-roses',
			...
			function(value) {
				it(value.pathExpression, function() {
					...
					const routeParams = localRoute.extractParameters(
						value.path
					);
	...
	describe('should return true for matched route regular', function() {
		...
		using(
			[
				...
				{
					pathExpression:
						'/something/:catId_:catName/:detailId-:color',
...

				{
					...
					path:
						'/something/5812_medium-mattresses_5687/5687710-white-210',
					result: true
				},
				{
					pathExpression:
				...
				{
					pathExpression:
						'/something/:catId_:catName/:?detailId-:?color/:?promo',
					path:
						'/something/5812_medium-mattresses/5687710-black/WINTER',
					result: true
				},
				...
				{
					pathExpression:
						'/something/:?catId/:?catName/:detailId/:color/:promo',
					path:
						'/something/5812/medium-mattresses/5687710/black/WINTER',
					result: false
				},
				{
					pathExpression: '/:param1/:?param2/:param3',
		...
		using(
			[
				...
				},
				{
					...
					clearPathExpr:
						':catId-:catName\\/:param\\/:\\?someId\\/:\\?anotherId',
					result: true
				},
				{
