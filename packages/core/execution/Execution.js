 ...
 * The execution can be either done in serial or in paralel way.
 * 
 * When executing jobs in paralel an option should define how to deal with
...
export default class Execution {
	 ...
	 * @param {Object} [options] Options to modify how jobs are executed.
	 * @returns {Promise}
	 */
	execute() {}
}