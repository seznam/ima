describe('Core.Socket.Proxy', function() {
	...
	var secure = false;
	beforeEach(function() {
		dispatcher = ns.oc.create('$Dispatcher');
		socketParser = ns.oc.create('Core.Socket.Parser');
		proxy = ns.oc.create('Core.Socket.Proxy', dispatcher, socketFactory, socketParser, config, secure);
	});
