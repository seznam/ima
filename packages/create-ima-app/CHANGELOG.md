...
- b8dd0ef: Update SWC and its Jest plugin to compatible versions.
...
- def750e: - **What?** Unfreeze pinned dependencies in the skeleton `package.json` template by adding `^` range prefix.
...
- 8bdeee5e0: Fixed issue where CIA referenced old versions of IMA.js
