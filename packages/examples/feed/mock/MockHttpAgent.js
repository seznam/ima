    ...
    this.items = [
      {
        _id: 1,
        content:
          'Isomorphic from the Greek "isos" for "equal" and "morph" for "shape". Isomorphism describes that if you look at the same entity in two different contexts, you should get the same thing.',
        category: 1,
      ...
      },
      {
        _id: 2,
        content:
          "In isomorphic javascript aplications are two contexts for one entity - server and client. Although the term has been mostly used in mathematics until now, it's an apt term to describe a web programing pattern where the code is shared by the front-end and back-end.",
        category: 2,
      ...
      },
      {
        _id: 3,
        content:
          'There are various isomorphic frameworks and libraries. <strong>This</strong> is one of them.',
        category: 1,
      ...
      },
      {
        _id: 6,
        content:
          'JavaScript applications which run both client-side and server-side. <strong>Isomorphic JavaScript frameworks</strong> are the next step in the evolution of JavaScript frameworks. These new libraries and frameworks are solving the problems associated with traditional JavaScript frameworks.',
        category: 1,
