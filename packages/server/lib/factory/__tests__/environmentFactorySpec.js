...
describe('environmentFactory', () => {
  ...
  describe('$Language default configuration', () => {
    it('should set default $Language when not provided in config', async () => {
      ...
      mock(mockConfigPath, mockConfig);

      const factory = (await import('../environmentFactory.js')).default;
    ...
    it('should preserve custom $Language configuration', async () => {
      process.env.NODE_ENV = 'production';
    ...
    it('should restore $Language after resolveEnvironmentSetting', async () => {
      process.env.NODE_ENV = 'production';
    ...
    it('should set default $Language after resolveEnvironmentSetting when not provided', async () => {
      process.env.NODE_ENV = 'production';
    ...
    it('should not mutate original $Language config object', async () => {
      process.env.NODE_ENV = 'production';
  ...
  describe('environment resolution', () => {
    it('should resolve production environment with NODE_ENV=production', async () => {
      process.env.NODE_ENV = 'production';
    ...
    it('should resolve development environment with NODE_ENV=development', async () => {
    ...
    it('should resolve development environment with $Language defined only in dev', async () => {
      process.env.NODE_ENV = 'development';
    ...
    it('should resolve development environment with $Language defined only in prod', async () => {
      process.env.NODE_ENV = 'development';
    ...
    it('should resolve development environment with $Language defined in both dev and prod', async () => {
      process.env.NODE_ENV = 'development';
    ...
    it('should prioritize IMA_ENV over NODE_ENV', async () => {
      process.env.NODE_ENV = 'development';
  ...
  describe('processEnvironment callback', () => {
    it('should call processEnvironment callback if provided', async () => {
      process.env.NODE_ENV = 'production';
      ...
      const processEnvironment = vi.fn(env => {
        return {
          ...env,
    ...
    it('should allow processEnvironment to modify $Language', async () => {
      process.env.NODE_ENV = 'production';
  ...
  describe('default environment merging', () => {
    it('should merge default environment with custom config', async () => {
      process.env.NODE_ENV = 'production';
    ...
    it('should override default settings with custom config', async () => {
      process.env.NODE_ENV = 'production';
